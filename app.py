...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        descuento_porcentaje = float(self.txt_descuento.get())
        descuento = importe * (descuento_porcentaje / 100)
        importe_con_descuento = importe - descuento
        alert_message = f"Importe con descuento: $ {importe_con_descuento:.2f}"
        tk.messagebox.showinfo("resultado", alert_message)
